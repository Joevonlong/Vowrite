...
- **[应用图标](docs/APP_ICON_GUIDE.md)** — 替换为自己的图标
- **[录音指示器](docs/THEME_GUIDE.md)** — 5 个内置预设，更多陆续推出
- **[AI 服务商](docs/PROVIDER_GUIDE.md)** — 通过 `providers.json` 添加自己的服务商

完整说明见 [自定义指南](docs/CUSTOMIZATION.md)。
...
```bash
ops/scripts/release.sh v0.2.3.0 "简短描述"
