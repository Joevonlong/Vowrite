...
public enum APIProvider: String, CaseIterable, Identifiable, Codable {
    ...
    case kimi = "Kimi (月之暗面)"
    case minimaxIntl = "MiniMax (International)"
    case minimaxCN = "MiniMax (CN)"
    case volcengine = "Volcengine (火山引擎)"
    case doubaoSpeech = "Doubao Speech (豆包语音)"
    case qwen = "Qwen (通义千问)"
    case gemini = "Google Gemini"
    case zhipu = "Zhipu (智谱清言)"
    case qianfan = "Baidu Qianfan (百度千帆)"
    ...
    public var providerID: String {
        ...
        case .minimaxIntl: return "minimax_intl"
        case .minimaxCN: return "minimax_cn"
        case .volcengine: return "volcengine"
        case .doubaoSpeech: return "doubaoSpeech"
