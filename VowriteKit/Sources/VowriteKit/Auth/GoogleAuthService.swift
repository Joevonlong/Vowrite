...
public enum GoogleAuthService {
    ...
    public static let redirectURI = "com.vowrite.app:/oauth2redirect"
    ...
    // UI is currently hidden — see F-006 in FEATURES.md for status.
    ...
    public static func exchangeCodeForTokens(code: String, codeVerifier: String) async throws -> GoogleTokenResponse {
        guard let clientID = clientID, !clientID.isEmpty else {
            throw GoogleAuthError.missingClientID
        }
    ...
    public static func decodeIDToken(_ idToken: String) -> GoogleUserInfo? {
