...
| OpenAI | `gpt-6-astra`, `gpt-5.4-mini`, `gpt-5.4-nano` | Polish | shortlist/default | [model catalog](https://developers.openai.com/api/docs/models) | Latest capable, value default, and economical choices; the catalog keeps the provider's documented per-model reasoning defaults. |
