...
struct OutputStyle: Identifiable, Codable, Equatable {
    let id: UUID
    var name: String
    ...
    static let builtinStyles: [OutputStyle] = [
        OutputStyle(
    ...
    static let noneId = UUID(uuidString: "00000000-0000-0000-0001-000000000001")!
}
